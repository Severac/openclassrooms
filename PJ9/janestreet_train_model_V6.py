...
V6 :
    run1 :
        ...
        Original source file is on training directory and on AWS  (this run1 version has been accidentaly overwritten with 2nd run version)
...
iteration_names = ['best_utility5_withoutgamma', 'best_utility4_withoutgamma', 'best_utility3_withoutgamma', 'best_utility2_withoutgamma', 'best_utility1_withoutgamma']
iteration_params = [
       {
   'features': ['feature_'+str(i)+'_x0' for i in range(130)] + ['weight_x0'], 
    'random_state': 42,
    'max_depth': 10,
    'n_estimators': 500,
    'learning_rate': 0.02,
