...
# Best model retrained in this script :
# {'colsample_bytree': [2], 'features': [1], 'learning_rate': [4], 'max_depth': [0], 'n_estimators': [0], 'random_state': [0], 'subsample': [0], 'tree_method': [0]}
# {'utility_score': 3234.3341462166127, 'utility_scores': [303.97262116961156, 115.74069002295101, 735.4651120566699, 38.00824384865681, 2041.1474791187236], 'utility_score_std': 737.8683320263681, 'accuracy_scores': [0.5185874465379725, 0.515592844704765, 0.5170027367957469, 0.5135016366668743, 0.5195761922301909]}
...
if (TRAIN_PERIMETER_SPLITS == True):
    ...
    # To do: add feature importances here
...
if (TRAIN_PERIMETER_ALL == True):
    ...
    print('Save model')
    model_wrapped.model_internal.save_model(MODEL_FILE)
