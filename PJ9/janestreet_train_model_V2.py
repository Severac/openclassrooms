...
V2 : 
    With models from "20/12 soir"
    
    FINAL MODEL SELECTED : "Best model for utility score of split 4" which has best utility score on kaggle submission
    
    Best model identified at iteration 82 of hyperopt
    
    Best model for utility score of split 1
    {'colsample_bytree': [5], 'features': [0], 'learning_rate': [1], 'max_depth': [1], 'n_estimators': [1], 'random_state': [0], 'subsample': [6], 'tree_method': [0]}
    loss:  -3265.602358
    utility scores : [235.21497907016132, 226.84574867761827, 595.8539048955168, 11.199105022790173, 2196.4886205363105]
    
    Best model for utility score of split 2
    {'colsample_bytree': [2], 'features': [0], 'learning_rate': [5], 'max_depth': [0], 'n_estimators': [1], 'random_state': [0], 'subsample': [6], 'tree_method': [0]}
    loss: -2768.765124
    utility scores: [74.29833817630187, 309.25601126096655, 706.3137076089242, 105.56135009856858, 1573.335717075042]
    
    Best model for utility score of split 3
    {'colsample_bytree': [1], 'features': [0], 'learning_rate': [0], 'max_depth': [1], 'n_estimators': [2], 'random_state': [0], 'subsample': [3], 'tree_method': [0]}
    loss: -3175.499804
    utility scores: [225.59143670415475, 248.38493912832203, 774.5085428708145, 56.324169850579885, 1870.6907153451414]
    
    Best model for utility score of split 4
    {'colsample_bytree': [8], 'features': [0], 'learning_rate': [1], 'max_depth': [1], 'n_estimators': [2], 'random_state': [0], 'subsample': [3], 'tree_method': [0]}
    loss: -2781.075189
    utility scores: [15.809447163022076, 166.76569856467142, 627.4190264586754, 295.92548122850434, 1675.155535552794]
    
    Best model for utility score of split 5 (and best mean score. But mean of split 5 is much higher than the others so it's not surprising that best utility of split 5 is the best mean utility)
    {'colsample_bytree': [5], 'features': [0], 'learning_rate': [1], 'max_depth': [1], 'n_estimators': [2], 'random_state': [0], 'subsample': [3], 'tree_method': [0]}
    loss: -3449.952551
    utility scores: [8.21122821970743, 249.99630629505893, 687.2746632257905, 85.67024740143403, 2418.80010572738]
...
params_20_12_bestmodel_utility1 = {
...
params_20_12_bestmodel_utility2 = {
   'features': ['feature_'+str(i) for i in range(130)], 
    'random_state': 42,
    'max_depth': 8,
    'n_estimators': 250,
...
params_20_12_bestmodel_utility3 = {
   'features': ['feature_'+str(i) for i in range(130)], 
    'random_state': 42,
    'max_depth': 10,
    'n_estimators': 500,
...
params_20_12_bestmodel_utility4 = {
   'features': ['feature_'+str(i) for i in range(130)], 
    'random_state': 42,
    'max_depth': 10,
    'n_estimators': 500,
...
params_20_12_bestmodel_utility5 = {
   'features': ['feature_'+str(i) for i in range(130)], 
    'random_state': 42,
    'max_depth': 10,
    'n_estimators': 500,
...
#params = params_20-12_bestmodel_utility5

iteration_names = ['best_utility5', 'best_utility4', 'best_utility3', 'best_utility2', 'best_utility1']
iteration_params = [params_20_12_bestmodel_utility5, params_20_12_bestmodel_utility4, params_20_12_bestmodel_utility3, params_20_12_bestmodel_utility2, params_20_12_bestmodel_utility1]
